  ...
  rounds: [
    {
      ...
      questions: [
        { qid:"ppg01", context: "She usually takes the bus, but this morning she ___ — you can see her at the end of the street.", text: "She usually walks, but today she ___ to work.", answer: "is cycling", options: ["is cycling", "cycles", "must be cycling", "has cycled"], afterflavour: "Is cycling = happening now, exceptional. Cycles = her permanent habit. Must be cycling = deduction, not observation. You can see her: it's direct evidence, not inference." },
    ...
    },
    {
      ...
      questions: [
        ...
        { qid:"ppg15", context: "Two siblings. Every meal. Every day. Their parents have accepted this.", text: "The kids are always ___ about the last piece — breakfast, lunch, dinner.", answer: "arguing", options: ["arguing", "argue", "argued", "going to argue"], afterflavour: "Are always arguing = parental exhaustion encoded in the form. Argue = neutral description." },
    ...
    },
    {
      ...
      questions: [
        { qid:"ppg09", context: "Vera ___ in the same flat she found when she arrived — she has looked at others and come back.", text:"Petra ___ in Zizkov.", answer: "lives", options: ["lives", "is living there while the renovation finishes", "lived there until recently", "has been living there recently"], afterflavour: "Lives = permanent. Is temporarily living = progressive, implies it will end. Fifteen years of looking and staying: this is not temporary." },
        { qid:"ppg12", context: "He ___ cards with the same three men every Tuesday — they have outlasted almost everything.", text:"He ___ cards with the same three people.", answer: "plays", options: ["plays", "is playing more often now he has retired", "played with them this week", "has played"], afterflavour: "Plays = permanent, enduring habit. Is currently playing = progressive, implies it might stop. Eleven years and counting: present simple." },
        { qid:"ppg19", context: "She ___ before the city wakes up — thirty years, three cities, non-negotiable.", text:"She ___ before the city wakes up.", answer: "runs", options: ["runs", "is running this month while training", "ran this morning", "has run"], afterflavour: "Runs = permanent identity. Is running this month = progressive, implies a temporary phase. Thirty years is not a phase." },
  ...
  rounds: [
    ...
    },
    {
      ...
      questions: [
        ...
        { qid:"hip-irr03", context:"Boston. January 1919. A disaster nobody expected.", text:"The molasses flood ___ through the streets faster than anyone could run.", answer:"swept", options:["swept","sweeped","has swept","was sweeping"], afterflavour:"Sweep - swept. Irregular. The flood moved at 56km/h." },
  ...
  rounds: [
    ...
    },
    {
      ...
      questions: [
        ...
        { qid:"prs-hab01", context: "Every Tuesday, without fail. The same three men for eleven years.", text:"He ___ cards with the same group every Tuesday evening.", answer: "plays", options: ["plays", "is playing tonight", "played last week", "has played"], afterflavour: "Plays = habitual, recurring fact. Is playing tonight = one specific occasion. Eleven years of Tuesdays: present simple habit." },
        { qid:"prs-hab02", context: "She ___ her coffee black. She has since she was nineteen.", text:"She ___ her coffee black — no milk, no sugar, not ever.", answer: "takes", options: ["takes", "is taking it black this week", "took it black before", "has taken"], afterflavour: "Takes = permanent habit. Is taking it black this week = implies it might change. Since nineteen: this is not temporary." },
        { qid:"prs-hab03", context: "The same route, the same time, every weekday for six years.", text:"He ___ to work. He has not taken the bus since 2018.", answer: "cycles", options: ["cycles", "is cycling until he gets a car", "cycled before moving", "has cycled"], afterflavour: "Cycles = stable routine. Is cycling until he gets a car = progressive, implies it will end. Six years with no car: present simple." },
        { qid:"prs-hab04", context: "Not a phone call. Not a text. Every Sunday, a letter.", text:"She ___ her grandmother a handwritten letter every Sunday.", answer: "sends", options: ["sends", "is sending one this week", "sent one last week", "has sent"], afterflavour: "Sends = regular habit, ongoing. Is sending one this week = one specific act. Third-person -s: present simple." }
      ]
    },
    {
      id: "prs-negatives",
    ...
    },
    {
      ...
      questions: [
        ...
        { qid:"bio-q01", context: "A neurosurgeon drills into a skull. The patient is awake.", text: "___ the brain register any of what is happening to it?", answer: "Does", options: ["Does", "Do", "Did", "Is"], afterflavour: "Does = third-person singular auxiliary for present simple questions. The brain (it) = Does. Do = plural. Did = past. Is = progressive/state, different structure." },
        { qid:"ani-q01", context: "The myth: elephants never forget. The reality: more specific.", text: "___ elephants actually have superior long-term spatial memory, or is that oversimplified?", answer: "Do", options: ["Do", "Does", "Did", "Are"], afterflavour: "Do = plural subject (elephants). Does = third-person singular. Elephants = they = Do. The capacity is real; the myth oversimplifies it." }
      ]
    },
    {
      id: "prs-disturbing",
      ...
      questions: [
        ...
        { qid:"sap-ps01", context:"Sapiens. Harari. A fact that stops people mid-sentence.", text:"Homo sapiens ___ as the sole surviving human species — at least five others existed alongside us and are now gone.", answer:"exists", options:["exists","is existing","existed","has existed"], afterflavour:"Exists = present state. We are the only one left. Is existing = progressive, wrong for a state. The others are gone." },
        { qid:"sap-ps02", context:"What makes human cooperation possible. The uncomfortable answer.", text:"Large-scale human cooperation ___ on shared fictions — money, nations, and laws exist because enough people believe in them.", answer:"depends", options:["depends","depended","is depending","has depended"], afterflavour:"Depends = present permanent fact. The fictions are real in their consequences even though they are not real in themselves." },
        { qid:"sap-ps03", context:"Agriculture. The revolution that might have made things worse.", text:"The average farmer in 10,000 BCE ___ harder and ___ worse than the average hunter-gatherer.", answer:"works", options:["works","worked","is working","has worked"], afterflavour:"Wait — this is a past reference. Worked. Past simple. The question is testing whether you catch the time reference." },
        { qid:"brain-ps01", context:"Energy cost. The organ that uses the most.", text:"The human brain ___ approximately 20% of the body's total energy despite being only 2% of its mass.", answer:"consumes", options:["consumes","consume","is consuming","consumed"], afterflavour:"Consumes = permanent biological fact. Third-person -s. The brain never stops billing." },
        { qid:"bone-ps01", context:"Stronger than concrete. But hollow.", text:"Human bone ___ stronger than reinforced concrete by weight — but hollow, which is why it can break.", answer:"is", options:["is","feels","seems","appears"], afterflavour:"Is = permanent physical property. Feels and seems = subjective perception. Bone is stronger than concrete: this is materials science, not impression." },
        { qid:"cell-ps01", context:"You are not the same body you were seven years ago. Almost literally.", text:"The human body ___ approximately 25 million new cells every second.", answer:"produces", options:["produces","produce","is producing more now than usual","produced"], afterflavour:"Produces = permanent biological rate. Is producing more now = implies variation. The rate is constant: present simple." }
      ]
    },
    {
      id: "prs-adverbs",
      ...
      questions: [
        { qid:"adv01", context: "He ___ arrives on time. The meetings have been starting without him for years.", text:"He ___ arrives on time for anything.", answer: "rarely", options: ["rarely", "always", "usually", "often"], afterflavour: "Rarely = almost never. The meetings start without him: the evidence supports rarely, not the others." },
        { qid:"adv02", context: "No exceptions. No special cases. Thirty years.", text:"She ___ checks her messages after 9pm.", answer: "never", options: ["never", "always", "sometimes", "often"], afterflavour: "Never before the main verb. After 9pm is the boundary: no exceptions = never." },
        { qid:"adv03", context: "Most weeks. Not every week. But most.", text:"He ___ goes to the market on Saturday morning.", answer: "usually", options: ["usually", "never", "rarely", "always"], afterflavour: "Usually = most of the time. Not every week eliminates always. Most weeks rules out rarely and never." },
        { qid:"adv04", context: "He is never late — in twenty years, not once.", text:"He is ___ late — the team have learned not to start without him.", answer: "never", options: ["never", "always", "often", "sometimes"], afterflavour: "Never after 'is' — frequency adverb follows the verb 'be'. Not once in twenty years = never." },
        { qid:"adv05", context: "About once a month. More in summer.", text:"They ___ eat at that restaurant.", answer: "occasionally", options: ["occasionally", "never", "always", "rarely"], afterflavour: "Occasionally = from time to time, not often. Once a month is more than rarely, less than often." },
        { qid:"adv06", context: "Every second sentence. His colleagues have stopped counting.", text:"He ___ interrupts before the other person has finished.", answer: "always", options: ["always", "sometimes", "rarely", "occasionally"], afterflavour: "Always = every time. Every second sentence with no exceptions: always. Adverb position: before the main verb." }
      ]
    }
  ],
  bossQuestions: [
